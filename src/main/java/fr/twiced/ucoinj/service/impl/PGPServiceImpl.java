...
public class PGPServiceImpl implements PGPService {
	...
	public PublicKey extractPublicKey(String base64stream) throws NoPublicKeyPacketException, IOException {
		...
		return new PublicKey(pubkeys, base64stream);
	}

	@Override
	public boolean verify(String originalDocument, String base64signature, PublicKey pubkey) throws BadSignatureException {
	...
	public String sign(String data, PGPPrivateKey pk) throws PGPException, SignatureException, IOException {
		...
		PGPSignatureGenerator sGen = new PGPSignatureGenerator(new BcPGPContentSignerBuilder(pk.getPublicKeyPacket().getAlgorithm(), PGPUtil.SHA256));
